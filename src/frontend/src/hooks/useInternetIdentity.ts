...
export function InternetIdentityProvider({
  ...
  // Store authClient and createOptions in refs so they never cause effect re-runs
  ...
  const login = useCallback(() => {
    ...
    if (
      ...
      // Already authenticated -- surface the existing identity
  ...
  // Initialize once on mount -- createOptionsRef used instead of createOptions
  // to prevent infinite loop from authClient being stored in state
  useEffect(() => {
