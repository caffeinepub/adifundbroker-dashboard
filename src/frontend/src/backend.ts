...
import type { DepositInput as _DepositInput, DepositOutput as _DepositOutput, DepositStatus as _DepositStatus, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllDeposits(): Promise<Array<DepositOutput>> {
        if (this.processError) {
            try {
    ...
    async getMyDeposits(): Promise<Array<DepositOutput>> {
        if (this.processError) {
            try {
    ...
    async getPolicy(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getPolicy();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTerms(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getTerms();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setFAQs(arg0: Array<Faq>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setFAQs(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setPolicy(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setPolicy(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setTerms(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setTerms(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_DepositOutput_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DepositOutput): DepositOutput {
...
function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "verified" in value ? DepositStatus.verified : "pending" in value ? DepositStatus.pending : "rejected" in value ? DepositStatus.rejected : value;
}
...
function to_candid_record_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        asset: value.asset,
        screenshotBlobId: value.screenshotBlobId ? candid_some(value.screenshotBlobId) : candid_none(),
        txid: value.txid,
        amount: value.amount
    };
}
